...
values."
  (setq-default
   ...
   ;; Lazy installatiospacemacsn of layers (i.e. layers are installed only when a file
...
values."
  (setq-default
   ...
   dotspacemacs-default-font '("Source Code Pro"  ;"FuraCode Nerd Font Mono Medium";
                               :size 15
                               :weight normal
                               :width normal
                               :powerline-scale 1.0)
